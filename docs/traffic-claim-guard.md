# Traffic Claim Guard
Generated at: 2026-06-06T13:37:17.966Z
...
| docs/automation-digest.md | 168 | ## Traffic Evidence |
| docs/automation-digest.md | 170 | - Traffic data available: false |
| docs/automation-digest.md | 171 | - Can claim traffic: false |
| docs/automation-digest.md | 173 | - Measured traffic sources: none |
| docs/automation-digest.md | 174 | - Search Console verification evidence: false |
| docs/automation-digest.md | 177 | - Unsupported traffic claims: 0 |
| docs/automation-digest.md | 178 | - Traffic claim files scanned: 69 |
| docs/automation-digest.md | 179 | - Traffic claim watch mentions: 387 |
| docs/automation-digest.md | 215 | \| Dify、n8n、MCP 和无代码 AI 自动化 \| 258 \| 0 \| 5 \| 无代码 AI 自动化容易吸引搜索流量，也最需要平台规则和权限边界提醒。 \| |
...
| docs/automation-gate.md | 33 | \| traffic claim guard found no unsupported claims \| PASS \| filesScanned=69, unsafeClaims=0, watchMentions=387 \| |
...
| docs/manual-review-workbench.md | 195 | - Traffic claim files scanned: 69 |
| docs/manual-review-workbench.md | 196 | - Traffic claim watch mentions: 387 |
| docs/manual-review-workbench.md | 269 | - Use docs/traffic-evidence-audit.md before making any traffic or Search Console performance claim. |
