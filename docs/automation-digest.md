...
Generated at: 2026-06-14T06:16:43.002Z
...
- Session actions: 194
- Source URL actions: 63
- Source target URL items: 19
- Source review actions: 131
- Search actions: 0
...
| ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1943 | source verification first | 17 | 6 | 42 | 0 | 0 | 0 | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
| 1939 | source verification first | 28 | 6 | 46 | 0 | 0 | 0 | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
| 1819 | source verification first | 18 | 7 | 43 | 0 | 0 | 0 | 客服 AI 该选什么模型：速度、成本、知识库、转人工和质检 | content/blog/ai-model-selection-customer-service-guide.mdx |
...
- Files covered: 23
- Files with reachable source: 23
...
| true | 801 | public-gap-review | public-gap-wave-1 | 24 | 2 | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
| true | 801 | public-gap-review | public-gap-wave-1 | 27 | 2 | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |

## Review Portfolio Board

- Source candidates: 38
- Unique items: 26
- Duplicate mentions: 12
- Multi-source items: 10
- Ready items: 26
- Safe draft items: 26
- Unsafe items: 0
- Source counts: {"deployment":10,"prompt":12,"publicGap":13,"wave":3}
...
| true | true | 950 | deployment, public-gap | 13 | 8 | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
...
- Safe draft items: 26
- Next assignments: 10
- With source targets: 26
- With search queries: 26
- Unsafe items: 0
...
- Items: 3
- Title covered items: 1
- Description covered items: 1
- Heading covered items: 0
- Body covered items: 1
- Search weak items: 2
...
- Already linked to public: 0
- Missing current public link: 3
- Packet unsafe items: 0
- Unsafe items: 0
...
| true | true | 4 | 0 | 5 | /blog/build-first-webpage-with-codex | 客服 AI 该选什么模型：速度、成本、知识库、转人工和质检 | content/blog/ai-model-selection-customer-service-guide.mdx |
...
| true | true | 7 | 18 | 25 | 15 | 11 | https://platform.openai.com/docs | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
...
| true | 4 | 15 | 9 | 32 | 11 | true | not-included | 客服 AI 该选什么模型：速度、成本、知识库、转人工和质检 | content/blog/ai-model-selection-customer-service-guide.mdx |
...
| 7 | true | queued-for-playbook | ai-deployment | 3 | 8 | true | not-included | Open WebUI Functions 和 Pipelines 怎么用：扩展模型、RAG 和外部工作流 | content/blog/open-webui-functions-pipelines-deployment-guide.mdx |
| 8 | true | queued-for-playbook | ai-deployment | 2 | 8 | true | not-included | AI 自动化项目怎么报价：Dify、n8n、RAG、Agent 和维护范围 | content/blog/ai-automation-project-pricing-scope-guide.mdx |
| 9 | true | queued-for-playbook | ai-deployment | 2 | 8 | true | not-included | BentoML 怎么部署 LLM：从本地 Service 到 BentoCloud 验收 | content/blog/bentoml-llm-deployment-beginner-guide.mdx |
| 10 | true | queued-for-playbook | public-coverage-gap | 3 | 5 | true | not-included | Agent 调工具怎么做权限控制：白名单、审批、沙箱和日志 | content/blog/agent-tool-permission-safety-guide.mdx |
...
- Items with coverage evidence: 0
- Items with fact-check queries: 0
- Items with official sources: 0
- Items with recommended queries: 0
- Total recommended queries: 0
- Unsafe items: 0
...
- Items with optimization actions: 7
- Unsafe items: 0
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 4 | true | true | 12/8 | 22/26 | 3 | 32 | true | not-included | AI API Key 怎么安全管理：环境变量、权限、轮换、泄露应急 | content/blog/ai-api-key-security-rotation-guide.mdx |
| 5 | true | true | 9/8 | 6/10 | 3 | 27 | true | not-included | MCP Server 怎么部署才安全：本地、远程、权限、日志和工具白名单 | content/blog/mcp-server-deployment-security-checklist.mdx |
| 6 | true | true | 12/8 | 8/12 | 3 | 35 | true | not-included | AI Agent 记忆和 RAG 怎么设计：短期记忆、长期记忆、引用来源和隐私边界 | content/blog/ai-agent-memory-rag-design-guide.mdx |
| 7 | true | true | 12/8 | 9/13 | 3 | 34 | true | not-included | Open WebUI Functions 和 Pipelines 怎么用：扩展模型、RAG 和外部工作流 | content/blog/open-webui-functions-pipelines-deployment-guide.mdx |
...
- Ready items: 16
- Safe draft items: 16
- Review queue matched items: 14
- Zero-public lane items: 12
- Items per lane max: 2
- Items with command boundary: 16
- Items with official sources: 16
- Items with search queries: 16
- Items with human checklist: 16
- Items with internal-link suggestion: 13
- Fact-check queries: 79
- Unsafe items: 0
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 689 | true | true | agent-deployment-tools-mcp | 0 | true | 4 | 10 | true | 1 | true | not-included | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
| 689 | true | true | agent-deployment-tools-mcp | 0 | true | 4 | 10 | true | 1 | true | not-included | AI Agent 记忆和 RAG 怎么设计：短期记忆、长期记忆、引用来源和隐私边界 | content/blog/ai-agent-memory-rag-design-guide.mdx |
| 685 | true | true | cross-industry-ai-prompts | 0 | true | 4 | 12 | true | 1 | true | not-included | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
| 679 | true | true | cross-industry-ai-prompts | 0 | true | 4 | 12 | true | 1 | true | not-included | 客服 AI 该选什么模型：速度、成本、知识库、转人工和质检 | content/blog/ai-model-selection-customer-service-guide.mdx |
| 677 | true | true | llm-deployment-and-serving | 0 | true | 4 | 10 | true | 1 | true | not-included | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
| 671 | true | true | llm-deployment-and-serving | 0 | true | 4 | 10 | false | 2 | true | not-included | 大模型成本监控怎么做：按用户、功能、模型和项目拆账 | content/blog/llm-cost-monitoring-dashboard-guide.mdx |
| 662 | true | true | rag-knowledge-base-agent-memory | 0 | true | 4 | 10 | true | 1 | true | not-included | AI 自动化项目怎么报价：Dify、n8n、RAG、Agent 和维护范围 | content/blog/ai-automation-project-pricing-scope-guide.mdx |
| 662 | true | true | rag-knowledge-base-agent-memory | 0 | true | 4 | 10 | true | 1 | true | not-included | n8n AI Agent 怎么接知识库和记忆：RAG、上下文和状态存储 | content/blog/n8n-ai-agent-rag-memory-guide.mdx |
| 642 | true | true | nocode-ai-automation-deployment | 0 | true | 4 | 10 | true | 1 | true | not-included | Dify 工作流怎么做错误处理：变量、分支、重试和人工兜底 | content/blog/dify-workflow-error-handling-guide.mdx |
| 642 | true | true | nocode-ai-automation-deployment | 0 | true | 4 | 10 | true | 1 | true | not-included | Dify Workflow 和 Agent 怎么选：固定流程、工具调用和人工审核 | content/blog/dify-workflow-vs-agent-guide.mdx |
| 610 | true | true | llm-evals-observability-security | 0 | true | 4 | 10 | true | 1 | true | not-included | MCP Server 怎么部署才安全：本地、远程、权限、日志和工具白名单 | content/blog/mcp-server-deployment-security-checklist.mdx |
| 609 | true | true | llm-evals-observability-security | 0 | true | 4 | 10 | true | 1 | true | not-included | Agent 调工具怎么做权限控制：白名单、审批、沙箱和日志 | content/blog/agent-tool-permission-safety-guide.mdx |
| 484 | true | true | ai-api-keys-limits-routing | 1 | true | 4 | 10 | true | 1 | true | not-included | AI API Key 怎么安全管理：环境变量、权限、轮换、泄露应急 | content/blog/ai-api-key-security-rotation-guide.mdx |
| 463 | true | true | ai-service-pricing-delivery | 4 | true | 4 | 10 | false | 2 | true | not-included | Agent 记忆用 Postgres 怎么设计：用户偏好、项目事实和过期规则 | content/blog/agent-memory-postgres-schema-guide.mdx |
...
| 437 | true | true | ai-service-pricing-delivery | 4 | false | 4 | 10 | false | 2 | true | not-included | 产品经理 AI 提示词模板：需求分析、PRD、竞品、用户故事和验收标准 | content/blog/product-manager-ai-prompts-guide.mdx |
...
| true | true | true | true | false | true | true | 2 | not-included | ai-service-pricing-delivery | Agent 记忆用 Postgres 怎么设计：用户偏好、项目事实和过期规则 | content/blog/agent-memory-postgres-schema-guide.mdx |
...
| 4 | 3/3 | 0 | 18 | Agent 记忆：短期记忆、长期记忆、RAG、Postgres + 全行业 AI 提示词和工作流模板 + Dify、n8n、Coze、Flowise、MCP 自动化部署 | content/blog/n8n-ai-agent-rag-memory-guide.mdx<br>content/blog/data-analysis-ai-prompts-guide.mdx<br>content/blog/n8n-ai-agent-webhook-production-guide.mdx |
| 5 | 3/3 | 0 | 18 | AI API 接入、限流、成本和多模型路由 + 开源大模型部署：Ollama、vLLM、TGI、RunPod + Agent 部署、工具调用和生产安全 | content/blog/helicone-llm-observability-guide.mdx<br>content/blog/llm-api-rate-limit-retry-guide.mdx<br>content/blog/ai-automation-project-pricing-scope-guide.mdx |
| 6 | 3/3 | 0 | 18 | Agent 记忆：短期记忆、长期记忆、RAG、Postgres + 全行业 AI 提示词和工作流模板 + 开源大模型部署：Ollama、vLLM、TGI、RunPod | content/blog/open-webui-functions-pipelines-deployment-guide.mdx<br>content/blog/industry-ai-prompts-template-library-2026.mdx<br>content/blog/llm-cost-monitoring-dashboard-guide.mdx |
...
| --- | --- | --- | --- | --- |
| 1 | 3/3 | 0 | 开源大模型部署：Ollama、vLLM、TGI、RunPod + Agent 部署、工具调用和生产安全 + Agent 记忆：短期记忆、长期记忆、RAG、Postgres | content/blog/bentoml-llm-deployment-beginner-guide.mdx<br>content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx<br>content/blog/agent-memory-postgres-schema-guide.mdx |
| 2 | 3/3 | 0 | RAG、知识库、向量数据库和引用溯源 + 全行业 AI 提示词和工作流模板 + Dify、n8n、Coze、Flowise、MCP 自动化部署 | content/blog/ai-model-selection-customer-service-guide.mdx<br>content/blog/ai-prompt-library-team-knowledge-base-guide.mdx<br>content/blog/mcp-server-deployment-security-checklist.mdx |
| 3 | 3/3 | 0 | AI API 接入、限流、成本和多模型路由 + 开源大模型部署：Ollama、vLLM、TGI、RunPod + Agent 部署、工具调用和生产安全 | content/blog/ai-api-key-security-rotation-guide.mdx<br>content/blog/gpu-docker-nvidia-container-toolkit-guide.mdx<br>content/blog/ai-agent-memory-rag-design-guide.mdx |
| 4 | 3/3 | 0 | Agent 记忆：短期记忆、长期记忆、RAG、Postgres + 全行业 AI 提示词和工作流模板 + Dify、n8n、Coze、Flowise、MCP 自动化部署 | content/blog/n8n-ai-agent-rag-memory-guide.mdx<br>content/blog/data-analysis-ai-prompts-guide.mdx<br>content/blog/n8n-ai-agent-webhook-production-guide.mdx |
| 5 | 3/3 | 0 | AI API 接入、限流、成本和多模型路由 + 开源大模型部署：Ollama、vLLM、TGI、RunPod + Agent 部署、工具调用和生产安全 | content/blog/helicone-llm-observability-guide.mdx<br>content/blog/llm-api-rate-limit-retry-guide.mdx<br>content/blog/ai-automation-project-pricing-scope-guide.mdx |
| 6 | 3/3 | 0 | Agent 记忆：短期记忆、长期记忆、RAG、Postgres + 全行业 AI 提示词和工作流模板 + 开源大模型部署：Ollama、vLLM、TGI、RunPod | content/blog/open-webui-functions-pipelines-deployment-guide.mdx<br>content/blog/industry-ai-prompts-template-library-2026.mdx<br>content/blog/llm-cost-monitoring-dashboard-guide.mdx |
| 7 | 3/3 | 0 | Agent 部署、工具调用和生产安全 + Agent 记忆：短期记忆、长期记忆、RAG、Postgres + 开源大模型部署：Ollama、vLLM、TGI、RunPod | content/blog/dify-workflow-error-handling-guide.mdx<br>content/blog/rag-citation-source-trace-guide.mdx<br>content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
| 8 | 3/3 | 0 | Agent 部署、工具调用和生产安全 + 开源大模型部署：Ollama、vLLM、TGI、RunPod | content/blog/dify-workflow-vs-agent-guide.mdx<br>content/blog/local-llm-vram-not-enough-guide.mdx<br>content/blog/enterprise-im-ai-agent-integration-guide.mdx |

| Wave | Ready | Link | H2 | Description | Actions | Warnings | Title | File |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | true | missing | 11 | 91 | 15 | 1 | BentoML 怎么部署 LLM：从本地 Service 到 BentoCloud 验收 | content/blog/bentoml-llm-deployment-beginner-guide.mdx |
| 1 | true | /blog/codex-vercel-deploy-preflight-checklist | 15 | 69 | 15 | 3 | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
...
| true | true | 313 | 5 | 11 | 27 | high | RAG、知识库、向量数据库和引用溯源 | 客服 AI 该选什么模型：速度、成本、知识库、转人工和质检 | content/blog/ai-model-selection-customer-service-guide.mdx |
...
- Launch pack items: 8
- Unique files: 8
- Preflight ready items: 8
- Source ready items: 8
- Snippet ready items: 8
- Schema ready items: 8
- Items with public link path: 8
- Query ready items: 8
- Command boundaries: 8
- Blocking items: 0
- Warning items: 8
...
- Immediate items: 3
- Backlog items: 5
- Ready for clearance review: 8
- Clearance actions: 63
- Source decision items: 3
- Failed source decision items: 1
- SEO warning items: 2
- Copydesk brief items: 4
- Popular prompt lane items: 5
- Mass search theme items: 6
- Publish confirm commands included: 0
- Traffic data available: false
- Unsafe items: 0
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- | --- |
| true | true | 777 | 11 | 0 | false | true | true | 5 | 1 | 客服 AI 该选什么模型：速度、成本、知识库、转人工和质检 | content/blog/ai-model-selection-customer-service-guide.mdx |
| true | true | 773 | 11 | 6 | false | false | true | 4 | 1 | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
| true | true | 769 | 9 | 1 | true | false | true | 6 | 1 | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
| false | true | 70 | 6 | 0 | false | false | true | 0 | 0 | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
| false | true | 64 | 6 | 0 | false | false | false | 4 | 3 | n8n AI Agent 怎么接知识库和记忆：RAG、上下文和状态存储 | content/blog/n8n-ai-agent-rag-memory-guide.mdx |
| false | true | 64 | 6 | 0 | false | false | false | 4 | 2 | MCP Server 怎么部署才安全：本地、远程、权限、日志和工具白名单 | content/blog/mcp-server-deployment-security-checklist.mdx |
...
- Briefs: 16
- Ready briefs: 16
- Briefs with action: 16
- Exact-query weak items: 3
- Missing public-link items: 15
- Unsafe commands: 0
...
| 801 | public-gap-wave-1 | 2 | /blog/codex-vercel-deploy-preflight-checklist | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
...
- Topics: 7
- Topics with ready candidates: 7

| Topic | Score | Public matches | Ready candidates | Why |
| --- | --- | --- | --- | --- |
| Agent 部署、工具调用和记忆 | 276 | 0 | 5 | Agent、记忆和工作流是高频 AI 应用词，但需要清楚解释边界和落地步骤。 |
| RAG、知识库和向量检索 | 272 | 0 | 5 | 很多团队会搜索知识库 AI，但真正需要的是可审核、可引用、可质检的方案。 |
...
- Planned wave theme matches: 22
- Missing subtopics: 25

| Theme | Score | Public | Ready | Review pack | Planned wave | Missing subtopics | Search seeds |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Agent deployment, tool calling, and production workflows | 382 | 0 | 35 | 1 | 4 | tool calling, human review, permissions, logs | AI Agent deployment tutorial<br>agent tool calling tutorial |
...
| RAG, knowledge base, and agent memory | 346 | 0 | 32 | 0 | 3 | knowledge base, vector database | RAG knowledge base tutorial<br>AI agent memory |
...
| Dify, n8n, Flowise, and no-code AI automation | 324 | 0 | 23 | 0 | 2 | self hosted, connector | Dify deployment tutorial<br>n8n AI agent self hosted |
| Business AI workflows and SOP templates | 322 | 0 | 15 | 0 | 1 | support, product, weekly report | AI workflow examples<br>AI use cases for business |
| LLM evaluation, observability, and security | 318 | 0 | 11 | 0 | 1 | logs, prompt injection, cost tracking | LLM observability<br>RAG evaluation |
...
| true | 10 | 5 | 18 | 12 | 0 | 销售话术、报价和方案书 AI 提示词 | 销售、BD、自由职业者和咨询顾问 |
...
| --- | --- | --- | --- |
| 1 | 2/2 | Agent deployment, tool calling, and production workflows + Cross-industry AI prompt templates | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx<br>content/blog/industry-ai-prompts-template-library-2026.mdx |
| 2 | 2/2 | RAG, knowledge base, and agent memory + Local and open-source model deployment | content/blog/ai-agent-memory-rag-design-guide.mdx<br>content/blog/open-webui-functions-pipelines-deployment-guide.mdx |
| 3 | 2/2 | Dify, n8n, Flowise, and no-code AI automation + Business AI workflows and SOP templates | content/blog/ai-automation-project-pricing-scope-guide.mdx<br>content/blog/dify-workflow-error-handling-guide.mdx |
| 4 | 2/2 | LLM evaluation, observability, and security + LLM serving, GPU, and managed inference | content/blog/ai-api-key-security-rotation-guide.mdx<br>content/blog/bentoml-llm-deployment-beginner-guide.mdx |

| Score | Ready | Theme | Missing subtopics | Primary keyword | Title | File |
| --- | --- | --- | --- | --- | --- | --- |
| 382 | true | Agent deployment, tool calling, and production workflows | tool calling, human review, permissions, logs | AI Agent 部署 | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
| 378 | true | Cross-industry AI prompt templates | customer service | 全行业 AI 提示词模板 | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
| 346 | true | RAG, knowledge base, and agent memory | knowledge base, vector database | AI Agent 记忆 | AI Agent 记忆和 RAG 怎么设计：短期记忆、长期记忆、引用来源和隐私边界 | content/blog/ai-agent-memory-rag-design-guide.mdx |
| 342 | true | Local and open-source model deployment | gpu memory, quantization, local api, model download | Open WebUI Functions Pipelines | Open WebUI Functions 和 Pipelines 怎么用：扩展模型、RAG 和外部工作流 | content/blog/open-webui-functions-pipelines-deployment-guide.mdx |
| 324 | true | Dify, n8n, Flowise, and no-code AI automation | self hosted, connector | AI 自动化项目报价 | AI 自动化项目怎么报价：Dify、n8n、RAG、Agent 和维护范围 | content/blog/ai-automation-project-pricing-scope-guide.mdx |
| 322 | true | Business AI workflows and SOP templates | support, product, weekly report | Dify 工作流错误处理 | Dify 工作流怎么做错误处理：变量、分支、重试和人工兜底 | content/blog/dify-workflow-error-handling-guide.mdx |
| 318 | true | LLM evaluation, observability, and security | logs, prompt injection, cost tracking | AI API Key 安全管理 | AI API Key 怎么安全管理：环境变量、权限、轮换、泄露应急 | content/blog/ai-api-key-security-rotation-guide.mdx |
...
- Items: 13
- Public gap plan items: 8
- Broad first coverage items: 8
- Broad first coverage preflight items: 8
- Ready items: 13
- Blocking items: 0
- Warning items: 13
- Structured data ready items: 13
- With public link suggestions: 13
- With search seed matches: 12
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | true | true | 0+5 | 0/9 | 3 | Agent deployment, tool calling, and production workflows | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
| 1 | true | true | 0+5 | 1/9 | 2 | Cross-industry AI prompt templates | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
...
| 1 | true | true | 0+5 | 0/5 | 2 | 开源大模型部署：Ollama、vLLM、TGI、RunPod | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
| 4 | true | true | 1+5 | 1/6 | 2 | LLM evaluation, observability, and security | AI API Key 怎么安全管理：环境变量、权限、轮换、泄露应急 | content/blog/ai-api-key-security-rotation-guide.mdx |

## Public Coverage Gap Decision Pack

- Items: 13
- Ready items: 13
- Review ready with optimizations: 13
- Blocking items: 0
- Unsafe items: 0
- Optimization actions: 43
- With source targets: 13
- With public link suggestions: 13
- With warning remediation: 13
- With command boundary: 13
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | human-review-ready-with-optimizations | medium | 11 | 3 | 3 | /blog/codex-vercel-deploy-preflight-checklist | Agent deployment, tool calling, and production workflows | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
| 1 | human-review-ready-with-optimizations | medium | 10 | 2 | 2 | /blog/upwork-client-requirements-analysis-beginner | Cross-industry AI prompt templates | 全行业 AI 提示词模板库怎么做：销售、运营、客服、HR、财务和教育都能用 | content/blog/industry-ai-prompts-template-library-2026.mdx |
| 2 | human-review-ready-with-optimizations | medium | 3 | 3 | 3 | /blog/codex-code-review-delivery-checklist | RAG, knowledge base, and agent memory | AI Agent 记忆和 RAG 怎么设计：短期记忆、长期记忆、引用来源和隐私边界 | content/blog/ai-agent-memory-rag-design-guide.mdx |
...
| 3 | human-review-ready-with-optimizations | medium | 2 | 5 | 5 | /blog/codex-code-review-delivery-checklist | Dify, n8n, Flowise, and no-code AI automation | AI 自动化项目怎么报价：Dify、n8n、RAG、Agent 和维护范围 | content/blog/ai-automation-project-pricing-scope-guide.mdx |
...
| 1 | human-review-ready-with-optimizations | medium | 10 | 2 | 2 | /blog/codex-vercel-deploy-preflight-checklist | 开源大模型部署：Ollama、vLLM、TGI、RunPod | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
| 4 | human-review-ready-with-optimizations | low | 15 | 2 | 2 | /blog/codex-code-review-delivery-checklist | LLM evaluation, observability, and security | AI API Key 怎么安全管理：环境变量、权限、轮换、泄露应急 | content/blog/ai-api-key-security-rotation-guide.mdx |
...
| --- | --- | --- | --- | --- | --- | --- |
| 226 | 0 | 3 | 5 | customer-service-ai-prompts | 客服 AI 回复模板 | Customer support prompt pack with ticket triage, empathy reply, escalation, refund boundary, and knowledge-base update. |
| 216 | 0 | 2 | 5 | sales-ai-prompts | 销售 AI 提示词 | Sales prompt pack with prospect research, discovery questions, objection handling, follow-up, and CRM summary. |
| 212 | 0 | 2 | 5 | hr-ai-prompts | HR AI 提示词 | HR prompt pack with JD draft, interview rubric, onboarding plan, performance review, and policy summary. |
| 208 | 0 | 2 | 5 | operations-ai-prompts | 运营 AI 提示词 | Operations prompt pack with SOP, weekly report, meeting summary, project risk list, and retrospective. |
| 206 | 0 | 2 | 5 | finance-ai-prompts | 财务 AI 提示词 | Finance prompt pack with variance narrative, budget review, cost driver summary, forecast assumptions, and board memo. |
| 204 | 0 | 2 | 5 | education-ai-prompts | 教师 AI 提示词 | Education prompt pack with lesson plan, quiz, student feedback, learning plan, and teaching-material rewrite. |
...
- Blocked items: 0
- High-risk items: 13
- With official sources: 13
- With reachable sources: 13
- Unsafe commands: 0
...
| true | high | 2026-06-13 | 26/26 | 12 | AI Agent 部署怎么做：用 Vercel AI SDK 理解工具调用、多步执行和上线检查 | content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
...
| true | high | 2026-06-13 | 27/27 | 12 | 大模型部署怎么选：Hugging Face Inference Endpoints、API、私有化和成本检查 | content/blog/llm-deployment-huggingface-inference-endpoints-guide.mdx |
...
| true | high | 2026-06-12 | 6/6 | 12 | n8n AI Agent 怎么接知识库和记忆：RAG、上下文和状态存储 | content/blog/n8n-ai-agent-rag-memory-guide.mdx |
| true | high | 2026-06-06 | 36/36 | 12 | AI API Key 怎么安全管理：环境变量、权限、轮换、泄露应急 | content/blog/ai-api-key-security-rotation-guide.mdx |

## Live Search Surface

- Latest check: 2026-06-14T06:16:39.346Z
- Ok: true
...
- Open docs/human-approval-repair-session-pack.md and run the next manual repair session for content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx.
