...
Generated at: 2026-06-16T12:51:10.598Z
...
| traffic claim guard found no unsupported claims | PASS | filesScanned=219, unsafeClaims=0, watchMentions=3829 |
...
| internal link opportunity audit is read-only and covers expansion candidates | PASS | public=500, expansion=19, broadFirst=8, candidates=22 |
...
| internal link sprint board covers all linkable candidates | PASS | items=22, waves=6, public=500, suggestions=66 |
| internal link sprint board keeps link edits manual and publish-safe | PASS | ready=22, actions=176, unsafe=0, publishConfirm=0 |
...
| human approval repair queue stays manual and non-publishing | PASS | humanGated=57/57, minimum=3/18, publishConfirm=0 |
| human approval repair route covers repair queue | PASS | files=3, minimumTasks=18, sessions=12, next=content/blog/ai-agent-deployment-vercel-ai-sdk-guide.mdx |
...
| human approval execution queue is read-only and covers approval wave | PASS | items=8, immediate=3, backlog=5, promptLanes=5, projected=500 |
| human approval execution queue stays human-gated and excludes publish confirm | PASS | ready=8, sourceDecisions=7, seoWarnings=5, promptLanes=5, publishConfirm=0 |
| human approval clearance pack is read-only and covers the full approval queue | PASS | items=8, immediate=3, backlog=5, failedSources=1, seo=5 |
| human approval clearance pack keeps all work human-gated and action-ready | PASS | ready=8, actions=72, sourceDecisions=3, copydesk=4, publishConfirm=0 |
...
| search snippet readiness audit is read-only and covers public plus expansion items | PASS | public=500, expansion=19, scoped=500 |
| search snippet readiness audit has no blocking Wave 1 issues | PASS | blocking=0, wave=3, waveBlocking=0, warnings=199 |
| structured data readiness audit is read-only and covers public plus expansion items | PASS | public=500, expansion=19, scoped=500 |
| structured data readiness audit has JSON-LD previews and no blocking Wave 1 issues | PASS | blocking=0, previews=500, wave=3, waveBlocking=0, warnings=92 |
| SEO warning remediation pack is read-only and mirrors snippet/schema warnings | PASS | items=255, snippet=199/199, schema=92/92 |
| SEO warning remediation pack keeps every SEO fix human-gated | PASS | ready=255, public=255, draft=0, gated=255 |
...
| popular prompt sprint board covers every broad prompt lane | PASS | items=10, queries=115, buckets=4, waves=5 |
| popular prompt sprint board keeps prompt expansion manual and publish-safe | PASS | ready=10, actions=90, nextFiles=10, publishConfirm=0 |
...
| wave approval packet is manual and ready | PASS | wave=1, items=3, ready=0, alreadyPublished=3 |
...
| wave publish simulation projects only approved Wave 1 items | PASS | wave=1, items=3, ready=0, alreadyPublished=3, projected=0 |
| wave publish simulation public total matches project status | PASS | current=500, projectedAfterApproval=0, projectedPublic=500 |
...
| public search refresh pack keeps public edits human-gated and action-ready | PASS | ready=500, actions=3579, highPriority=273, shortDescriptions=457, publishConfirm=0 |
...
| public refresh sprint board keeps public edits manual and publish-confirm-free | PASS | ready=500, actions=5237, unsafe=0, publishConfirm=0 |
| public search refresh session pack covers public sprint waves | PASS | sessions=167, files=500, actions=5237, ready=500 |
...
| manual review workbench includes SEO warning remediation | PASS | workbenchSeo=255, remediation=255, unsafe=0 |
