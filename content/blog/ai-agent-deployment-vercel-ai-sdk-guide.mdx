...
secondaryKeywords:
  ...
  - "AI Agent 上线检查"
  - "AI Agent 多步执行"
sourceNotes: "已于 2026-06-12 按 Vercel AI SDK 官方 Agents、ToolLoopAgent、tool calling、human-in-the-loop 文档核对核心概念；结合实际 Web 应用部署流程整理。正式公开前仍需人工复核 API 示例、版本和平台限制。"
