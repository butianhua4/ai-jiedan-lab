...
qualityScore: 100
publishBatch: 24
canonical: 'https://ai-jiedan-lab.vercel.app/blog/qdrant-vector-database-beginner-guide'
noindex: false
---
...
这篇是草稿，正式发布前需要核对 Qdrant 最新文档。向量数据库基础可以看 [向量数据库怎么选](/blog/vector-database-beginner-guide)，Embedding 可以看 [Embedding 模型怎么选](/blog/embedding-model-selection-guide)。
