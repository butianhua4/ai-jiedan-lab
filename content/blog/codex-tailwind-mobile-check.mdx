...
description: "给 AI 接单新手的一套 Tailwind 移动端样式检查流程：用 Codex 辅助定位类名和布局风险，但由人工确认真实视口、溢出、按钮、导航、表单和截图证据。"
date: "2026-06-02"
...
接单场景还要注意客户素材。logo、长英文单词、产品图、价格表、第三方嵌入和表单字段都可能撑破布局。不要只用你自己的短文案测试。
...
先审查，再修改，比直接生成新布局更稳。尤其接单时，客户关心的是问题是否被可靠修复，而不是代码看起来更复杂。
