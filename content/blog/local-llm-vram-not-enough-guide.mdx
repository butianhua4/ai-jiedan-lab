...
qualityScore: 100
publishBatch: 32
canonical: 'https://ai-jiedan-lab.vercel.app/blog/local-llm-vram-not-enough-guide'
noindex: false
---
...
本文是待复核草稿。基础部署可以看 [本地大模型部署入门](/blog/local-llm-deployment-beginner)，vLLM 部署可以看 [vLLM 部署新手指南](/blog/vllm-deployment-beginner-guide)。
