...
secondaryKeywords:
  ...
  - Gemini API 重试
sourceNotes: >-
  参考 Google AI for Developers Gemini API rate limits 文档和常见 API
  稳定性设计整理；正式发布前需要人工核对最新额度。
...
qualityScore: 100
publishBatch: 34
canonical: 'https://ai.aporet.com/blog/gemini-api-rate-limit-debug-guide'
noindex: false
---
