...
description: >-
  整理 Open WebUI Functions 与 Pipelines 的使用边界，覆盖 provider
  接入、RAG、消息过滤、外部工作流、安全和部署检查。
date: '2026-06-06'
...
publishBatch: 33
canonical: >-
  https://ai-jiedan-lab.vercel.app/blog/open-webui-functions-pipelines-deployment-guide
noindex: false
---
