---
title: Agent 记忆数据库怎么设计：Postgres 用户偏好、项目事实和过期规则
...
secondaryKeywords:
  ...
  - Agent 记忆表结构
sourceNotes: >-
  参考 LangChain memory 概念、OpenAI Agents SDK memory 与 tracing 文档整理；正式发布前需要人工核对具体
  SDK、数据库权限和隐私要求。
...
qualityScore: 100
publishBatch: 32
canonical: 'https://ai.aporet.com/blog/agent-memory-postgres-schema-guide'
noindex: false
---
