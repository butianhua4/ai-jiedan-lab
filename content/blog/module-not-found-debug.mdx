...
description: "新手遇到 module not found 时，不要立刻乱装包。本文按报错来源、导入语句、文件路径、大小写、依赖安装、路径别名和构建环境拆解定位流程，帮助你判断该改代码还是请客户补材料。"
date: "2026-06-03"
...
也适合接单练习者。客户常把这类错误描述成“项目跑不起来”，但你要先确认是缺依赖、路径错误、大小写问题，还是仓库文件本身没提交完整。
