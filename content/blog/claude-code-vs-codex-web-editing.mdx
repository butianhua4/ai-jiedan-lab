...
description: "给 AI 接单新手看的网页修改工具选择指南：什么时候用 Claude Code，什么时候用 Codex，如何判断任务范围、验证结果和交付风险。"
date: "2026-06-03"
...
difficulty: "beginner"
targetReader: "想用 Claude Code 或 Codex 辅助网页修改的新手接单者"
...
这篇草稿建议和 [网页修改检查清单](/blog/claude-code-vs-codex-web-editing-checklist)、[接单范围判断](/blog/claude-code-vs-codex-web-editing-freelance-scope)、[/tools/proposal-generator](/tools/proposal-generator) 一起使用。
...
如果客户只给了截图，没有代码仓库，可以先把任务定义为诊断或建议，不要直接承诺修改。如果客户给了仓库但没有运行说明，第一轮回复应该先追问安装、启动、构建和验收方式。工具可以帮你生成追问列表，但是否继续接单要由你判断。
...
本文仅供学习和接单流程参考，不构成职业、法律、安全或平台合规建议。Claude Code、Codex 和相关平台功能可能变化，发布前需要人工复核。任何网页修改都应以真实需求、可验证结果和客户授权为准。
