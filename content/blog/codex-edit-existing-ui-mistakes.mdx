...
description: 整理 AI 工具新手用 Codex 修改现有网页 UI 时常见错误：没留截图、改动范围过大、忽略响应式、破坏设计系统、没写交付记录，以及补救顺序。
date: '2026-06-02'
...
qualityScore: 100
publishBatch: 2
canonical: 'https://ai.aporet.com/blog/codex-edit-existing-ui-mistakes'
noindex: false
---
