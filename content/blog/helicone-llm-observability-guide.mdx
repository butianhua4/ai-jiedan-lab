...
description: "面向新手整理 Helicone LLM 观测入门，覆盖 AI Gateway、OpenAI-compatible 接口、日志、成本、缓存、限流、错误排查和隐私边界。"
date: "2026-06-05"
...
sourceNotes: "参考 Helicone 官方 Quickstart、AI Gateway、Platform Overview 和 proxy/integration 文档整理；正式发布前需要人工核对最新网关、价格、日志和数据配置。"
