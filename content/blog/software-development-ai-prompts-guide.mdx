...
sourceNotes: >-
  ...
  generation、Structured Outputs、GitHub Copilot prompt engineering 和 OWASP Top 10
  for LLM Applications 核对提示词结构、输出格式、复核原则和安全边界；结合需求拆解、代码审查、Bug
  排查和测试用例流程整理。正式公开前仍需人工核对项目上下文、安全要求、依赖许可和代码使用边界。
