...
description: >-
  面向新手整理 LM Studio 本地服务器和 OpenAI 兼容 API 使用思路，覆盖模型下载、Server 模式、Base URL、SDK
  接入、局域网和风险。
date: '2026-06-05'
...
secondaryKeywords:
  ...
  - LM Studio 局域网
sourceNotes: >-
  参考 LM Studio 官方文档关于本地服务器、OpenAI-like
  endpoints、离线运行和工具调用说明整理；正式发布前需要人工核对最新界面和端口。
