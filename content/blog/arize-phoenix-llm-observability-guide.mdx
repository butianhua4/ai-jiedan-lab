...
description: >-
  面向新手整理 Arize Phoenix LLM observability 入门，覆盖
  tracing、OpenTelemetry、OpenInference、RAG/Agent 排错、评测和敏感数据边界。
date: '2026-06-05'
...
secondaryKeywords:
  ...
  - LLM evaluation
sourceNotes: >-
  参考 Arize Phoenix 官方文档中 tracing、OpenTelemetry/OpenInference、LLM
  observability、evaluation 和 MCP tracing 方向整理；正式发布前需要人工核对最新 SDK 和部署方式。
