...
description: >-
  面向新手整理 Open WebUI 搭配 Ollama 的 Docker 部署思路，覆盖本机模型、Docker
  网络、端口、模型连接、知识库测试和上线前检查。
date: '2026-06-05'
...
sourceNotes: >-
  参考 Open WebUI 官方 Quick Start、Ollama provider 文档和 Ollama Docker
  文档整理；正式发布前需要人工核对最新命令、镜像名和连接地址。
