...
description: >-
  一份给新手使用的 package-lock.json 冲突检查清单，帮助确认 git 状态、包管理器、package.json
  变更、锁文件来源、验证命令和客户待确认事项。
date: '2026-06-03'
...
qualityScore: 100
publishBatch: 18
canonical: 'https://ai.aporet.com/blog/package-lock-conflict-fix-checklist'
noindex: true
---
