...
secondaryKeywords:
  ...
  - 生产复盘 AI
sourceNotes: >-
  已于 2026-06-14 参考 OpenAI Prompt engineering、Prompt guidance、Safety best
  practices、NIST AI Risk Management Framework 和 McKinsey operations
  公开资料整理；正式发布前需要人工核对工厂安全规范、设备资料、质量体系、客户保密要求和适用行业标准。
