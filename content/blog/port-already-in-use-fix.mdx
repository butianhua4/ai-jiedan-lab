...
qualityScore: 100
publishBatch: 18
canonical: 'https://ai.aporet.com/blog/port-already-in-use-fix'
noindex: true
---
...
把端口号、启动命令和完整报错复制到 [报错解释器](/tools/error-explainer) 做第一轮拆解。需要判断是否适合项目，可以用 [项目报价助手](/tools/pricing-calculator) 拆范围。
