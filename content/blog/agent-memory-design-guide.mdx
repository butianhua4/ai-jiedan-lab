...
secondaryKeywords:
  ...
  - "长期记忆"
  - "用户偏好存储"
sourceNotes: "已于 2026-06-12 按 OpenAI Agents guardrails / human review 文档、Vercel AI SDK Agents 文档核对 Agent 状态、人工确认和工具边界；结合短期记忆、长期记忆、用户偏好和隐私最小化原则整理。正式公开前仍需人工复核数据库结构、保留周期和隐私合规要求。"
