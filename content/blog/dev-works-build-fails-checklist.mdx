...
description: 一份给新手的 build 失败检查清单，覆盖完整日志、失败阶段、TypeScript、lint、环境变量、静态生成、路径大小写、依赖版本和项目暂停条件。
date: '2026-06-03'
...
qualityScore: 100
publishBatch: 15
canonical: 'https://ai.aporet.com/blog/dev-works-build-fails-checklist'
noindex: false
---
