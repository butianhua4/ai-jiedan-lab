...
description: >-
  面向新手整理 OpenAI Agents SDK 入门路线，覆盖 agent、tools、handoffs、running
  agents、tracing、敏感数据、评测和上线边界。
date: '2026-06-05'
...
secondaryKeywords:
  ...
  - Agent SDK 教程
sourceNotes: >-
  参考 OpenAI Agents SDK 官方 Python/JS 文档中 running agents、handoffs、tracing
  和敏感数据配置方向整理；正式发布前需要人工核对最新 API、包名和模型要求。
