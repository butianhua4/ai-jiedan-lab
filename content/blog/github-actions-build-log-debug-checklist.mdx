...
description: >-
  一份给新手使用的 GitHub Actions build 失败日志检查清单，覆盖
  workflow、job、step、关键错误、依赖、测试、环境变量、权限、部署平台和客户确认事项。
date: '2026-06-03'
...
difficulty: beginner
targetReader: 需要逐项排查 GitHub Actions 构建日志的新手和项目练习者
...
qualityScore: 100
publishBatch: 13
canonical: 'https://ai.aporet.com/blog/github-actions-build-log-debug-checklist'
noindex: true
---
