...
secondaryKeywords:
  ...
  - "Next.js AI 接口"
  - "Gemini 多模态"
sourceNotes: "参考 Google AI for Developers Gemini API Quickstart 和 API 文档整理；正式发布前需要人工核对最新 SDK、模型名、环境变量和价格。"
...
qualityScore: 86
publishBatch: 27
canonical: "https://ai-jiedan-lab.vercel.app/blog/gemini-api-nextjs-guide"
noindex: true
---
...
这篇是草稿，正式发布前需要核对 Google AI 最新官方文档。类似的 Next.js 接口结构可以看 [OpenAI API Next.js Route Handler 指南](/blog/openai-api-nextjs-route-handler-guide)，聊天部署可以看 [Vercel AI SDK 聊天机器人部署](/blog/vercel-ai-sdk-chatbot-deploy-guide)。
