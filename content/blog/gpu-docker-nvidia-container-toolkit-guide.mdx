---
title: "Docker 怎么用 NVIDIA GPU：大模型部署先装对 Container Toolkit"
slug: "gpu-docker-nvidia-container-toolkit-guide"
description: "面向新手整理 Docker 使用 NVIDIA GPU 的部署检查点，覆盖驱动、NVIDIA Container Toolkit、Docker runtime、nvidia-smi、CUDA 镜像和排错。"
date: "2026-06-05"
...
secondaryKeywords:
  ...
  - "nvidia-smi docker"
  - "CUDA 容器"
sourceNotes: "参考 NVIDIA Container Toolkit 官方安装文档和 NVIDIA deep learning container 文档方向整理；正式发布前需要人工核对最新 Linux 发行版、Docker 和 toolkit 版本。"
...
qualityScore: 86
publishBatch: 29
canonical: "https://ai-jiedan-lab.vercel.app/blog/gpu-docker-nvidia-container-toolkit-guide"
noindex: true
---
...
这篇是草稿，正式发布前需要核对 NVIDIA 最新官方文档。vLLM 部署可以看 [vLLM 部署入门](/blog/vllm-deployment-beginner-guide)，本地大模型基础可以看 [本地大模型部署入门](/blog/local-llm-deployment-beginner)。
