...
description: "面向新手整理 Modal Serverless GPU 部署 LLM 的路线，覆盖 image、function、GPU、volume、模型缓存、endpoint、费用和上线检查。"
date: "2026-06-05"
...
secondaryKeywords:
  ...
  - "Modal endpoint"
  - "Serverless LLM"
sourceNotes: "参考 Modal 官方 guide、LLM inference 示例、GPU 和 volumes 文档方向整理；正式发布前需要人工核对最新 SDK、价格、GPU 类型和部署语法。"
